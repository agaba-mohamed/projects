...
syscall_t table[NB_SYSCALLS] = {{0, "read", 3, NUM, NUM, VOID_P, NUM, 0, 0, 0},
...
char *get_syscall_info(int num)
{
    syscall_t *syscall;
    syscall = get_syscall(num);
...
int get_syscall_type(syscall_t *syscall, int i)
{
    switch (i) {
    case 0:
        return (syscall->arg1);
