...
def main():
    ...
    draw_number(1, 0, 0, grid_points, device)
    draw_number(2, 1, 0, grid_points, device)
    draw_number(3, 2, 0, grid_points, device)
    draw_number(4, 3, 0, grid_points, device)
    draw_number(5, 4, 0, grid_points, device)
    draw_number(6, 5, 0, grid_points, device)
    draw_number(7, 6, 0, grid_points, device)
    draw_number(8, 7, 0, grid_points, device)
    draw_number(9, 8, 0, grid_points, device)
